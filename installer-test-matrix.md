...
| Windows | Unsupported Visual Studio version is used (something other than 16.9.2 - 16.11.x) | 1.  If it is already installed, uninstall Visual Studio<br>    1.  To uninstall:<br>2.  Install a version of Visual Studio that falls outside the supported version range<br>3.  If not already installed, install the remaining prerequisites found at: [https://www.o3de.org/docs/welcome-guide/requirements/](https://www.o3de.org/docs/welcome-guide/requirements/)<br>4.  Install most recent release installer<br>5.  Launch O3DE.exe<br>6.  Create a project if one doesn't exist<br>7.  Build the project<br>8.  Launch the Editor | Possibly able to modify the install to a different version? I need to get more information for this. |
